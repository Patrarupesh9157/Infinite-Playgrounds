...
@section('page-script')
    @vite(['resources/assets/js/admin/product-list.js'])
@endsection
    ...
    <div class="card">
        <div class="card-datatable table-responsive">
            ...
            <div class="d-flex justify-content-end p-2">
                <a class="btn btn-primary btn-sm add-new" data-bs-toggle="offcanvas" data-bs-target="#productform"
                    href="{{ route('admin.products.store') }}" title="Form">
                    <span>
                        <i class="ti ti-plus ti-xs" style="margin-bottom: 2px;"></i>
                        <span class="d-none d-sm-inline-block btn_spacing">{{ __('Add Product') }}</span>
                    </span>
                </a>
            </div>
            <table class="datatables-product table" data-url="{{ route('admin.products.index') }}">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Design Name</th>
        ...
        <!-- Fields -->
        @include('admin.products.add-edit')
    </div>
